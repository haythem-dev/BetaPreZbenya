...
export default function FreelanceOpportunities() {
  return (
    <BackgroundWithCircles className="py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-end mb-10">
          <div>
            <h2 className="text-3xl font-bold text-gray-900 mb-2">Freelance Opportunities</h2>
            <p className="text-gray-600">Join our network of tech professionals and work on exciting projects</p>
          </div>
          <a href="/freelance" className="hidden md:flex items-center text-primary font-medium">
              ...
              <div className="p-6">
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  {opportunity.skills.map((skill, index) => (
                    <span key={index} className="bg-primary/5 text-primary text-xs font-medium px-2 py-1 rounded-full">
                      {skill}
                    </span>
                  ))}
                </div>
                ...
                <div className="flex justify-between items-center mt-2">
                  <a href={`/freelance/${opportunity.id}`} className="text-primary font-medium flex items-center">
                    View Details
                    <svg className="ml-1 h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                      <path fillRule="evenodd" d="M12.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-2.293-2.293a1 1 0 010-1.414z" clipRule="evenodd" />
                    </svg>
                  </a>
                  <a href="/apply" className="bg-primary hover:bg-primary/90 text-white text-sm font-medium px-4 py-2 rounded-lg transition">
                    Apply Now
                  </a>
                </div>
              </div>
